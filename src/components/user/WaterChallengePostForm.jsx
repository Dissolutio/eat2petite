...
export default function WaterChallengePostForm(props) {
	...
	const { selectedDate, setSelectedDate, contestStartDate, contestEndDate, userSelectedContest } = props
	console.log("TCL: WaterChallengePostForm -> userSelectedContest", userSelectedContest)
	...
	const dateChangeHandler = (event) => {
		...
		if (isWithinInterval(newDate, { start: contestStartDate, end: contestEndDate })) {
			...
			<Form onSubmit={createPostOnSubmit} className="border border-primary rounded p-4 mt-4 mb-3 text-center">
				...
				<FormGroup>
					...
					<Input name="postDate" type="date"
						onChange={dateChangeHandler} value={selectedDate} />
				</FormGroup>
				<FormGroup>
