...
export default function ChallengePost(props) {
      ...
      data: {
        challenge1: {
          quantityWaterDrank:
            ...
            currentPost.data.challenge1.quantityWaterDrank,
          quantityWaterDrankUnits:
            (event.target.quantityWaterDrankUnits &&
              event.target.quantityWaterDrankUnits.value) ||
            currentPost.data.challenge1.quantityWaterDrankUnits,
        },
        challenge2: {
          servingsVegetablesEaten:
            (event.target.servingsVegetablesEaten &&
              event.target.servingsVegetablesEaten.value) ||
            currentPost.data.challenge2.servingsVegetablesEaten,
        },
        challenge3: {
          proteinConsumed:
            (event.target.proteinConsumed &&
              event.target.proteinConsumed.value) ||
            currentPost.data.challenge3.proteinConsumed,
        },
        challenge4: {
  ...
  return (
    <Container className='p-4 mt-4 mb-3 text-center'>
      <h5 className='text-primary border-bottom border-primary'>
