...
export default function ChallengePost(props) {
  ...
  const formState = {
    quantityWaterDrank, quantityWaterDrankUnits, servingsVegetablesEaten,
    proteinConsumed, proteinConsumedUnits, lightExcerciseDuration,
    mediumExcerciseDuration, heavyExcerciseDuration, refinedCarbsConsumed,
    refinedCarbsConsumedUnits, quantitySugarConsumed, quantitySaltConsumed,
    quantitySugarConsumedUnits, quantitySaltConsumedUnits
  }
  React.useEffect(() => {
    // Reset Form values
    if (!(currentPost && currentPost.data)) return
    quantityWaterDrank.setInputValue(currentPost && currentPost.data.challenge1.quantityWaterDrank)
    quantityWaterDrankUnits.setInputValue(currentPost && currentPost.data.challenge1.quantityWaterDrankUnits)
    servingsVegetablesEaten.setInputValue(currentPost && currentPost.data.challenge2.servingsVegetablesEaten)
    proteinConsumed.setInputValue(currentPost && currentPost.data.challenge3.proteinConsumed)
    proteinConsumedUnits.setInputValue(currentPost && currentPost.data.challenge3.proteinConsumedUnits)
    lightExcerciseDuration.setInputValue(currentPost && currentPost.data.challenge4.lightExcerciseDuration)
    mediumExcerciseDuration.setInputValue(currentPost && currentPost.data.challenge4.mediumExcerciseDuration)
    heavyExcerciseDuration.setInputValue(currentPost && currentPost.data.challenge4.heavyExcerciseDuration)
    refinedCarbsConsumed.setInputValue(currentPost && currentPost.data.challenge5.refinedCarbsConsumed)
    refinedCarbsConsumedUnits.setInputValue(currentPost && currentPost.data.challenge5.refinedCarbsConsumedUnits)
    quantitySugarConsumed.setInputValue(currentPost && currentPost.data.challenge6.quantitySugarConsumed)
    quantitySaltConsumed.setInputValue(currentPost && currentPost.data.challenge6.quantitySaltConsumed)
    quantitySugarConsumedUnits.setInputValue(currentPost && currentPost.data.challenge6.quantitySugarConsumedUnits)
    quantitySaltConsumedUnits.setInputValue(currentPost && currentPost.data.challenge6.quantitySaltConsumedUnits)
